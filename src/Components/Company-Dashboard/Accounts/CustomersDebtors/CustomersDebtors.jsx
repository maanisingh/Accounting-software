...
const CustomersDebtors = () => {
    ...
    try {
      ...
      if (response?.data?.success) {
        ...
        const transformedCustomers = customersArray.map((apiCustomer) => {
          // Map API fields (camelCase from backend) to component fields
          return {
            id: apiCustomer.id,
            name: apiCustomer.name,
            nameArabic: "", // Not available in v1 API
            companyName: apiCustomer.name,
            contact: apiCustomer.phone,
            email: apiCustomer.email,
            taxNumber: apiCustomer.taxNumber || "",
            altMobile: "",
            balance: apiCustomer.creditLimit?.toString() || "0.00",
            accountBalance: apiCustomer.creditLimit?.toString() || "0.00",
            taxEnabled: !!apiCustomer.taxNumber,
            accountType: "Sundry Debtors",
            accountName: "Accounts Receivable",
            balanceType: "Debit",
            creationDate: apiCustomer.createdAt,
            bankAccountNumber: "",
            bankIFSC: "",
            bankName: "",
            country: apiCustomer.country || "",
            state: apiCustomer.state || "",
            pincode: apiCustomer.postalCode || "",
            address: apiCustomer.address || "",
            stateCode: "",
            shippingAddress: apiCustomer.address || "",
            creditPeriod: apiCustomer.creditDays?.toString() || "30",
            gstin: apiCustomer.taxNumber || "",
            gstEnabled: !!apiCustomer.taxNumber,
            companyLocation: "",
            idCardImage: "",
            extraFile: "",
            billing: {
  ...
  const handleSave = (savedCustomer, mode) => {
    if (savedCustomer) {
      // Transform the API response (camelCase) to match our component structure
      const transformedCustomer = {
        id: savedCustomer.id,
        name: savedCustomer.name,
        nameArabic: "",
        companyName: savedCustomer.name,
        contact: savedCustomer.phone,
        email: savedCustomer.email,
        taxNumber: savedCustomer.taxNumber || "",
        altMobile: "",
        balance: savedCustomer.creditLimit?.toString() || "0.00",
        taxEnabled: !!savedCustomer.taxNumber,
        accountType: "Sundry Debtors",
        accountName: "Accounts Receivable",
        balanceType: "Debit",
        creationDate: savedCustomer.createdAt,
        bankAccountNumber: "",
        bankIFSC: "",
        bankName: "",
        country: savedCustomer.country || "",
        state: savedCustomer.state || "",
        pincode: savedCustomer.postalCode || "",
        address: savedCustomer.address || "",
        stateCode: "",
        shippingAddress: savedCustomer.address || "",
        creditPeriod: savedCustomer.creditDays?.toString() || "30",
        gstin: savedCustomer.taxNumber || "",
        gstEnabled: !!savedCustomer.taxNumber,
        companyLocation: "",
        idCardImage: "",
        extraFile: "",
        billing: {
